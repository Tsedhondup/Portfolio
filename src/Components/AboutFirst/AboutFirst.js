...
const AboutFirst = () => {
  ...
  return (
    <section className="about-first">
      <div className="about-first__image-container-wrapper">
      ...
      <div className="about-text-container-wrapper">
        <section className="about-text-container">
          ...
          <section className="about-text about-text-journey">
            ...
            <p className="about-text__para">
              ...
              the video was, I was rather excited to learn coding as a hobby.
            </p>
            {/* Icons */}
          ...
          <section className="about-text about-text-certification">
            ...
            <p className="about-text__para">
              Teaching myself to code was of great success, and it continues to
